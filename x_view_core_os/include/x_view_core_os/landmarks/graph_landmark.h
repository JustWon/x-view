#ifndef X_VIEW_GRAPH_LANDMARK_FOLDER_
#define  X_VIEW_GRAPH_LANDMARK_FOLDER_

// Since graph landmarks are complex objects, and putting all relevant code
// into a single header/source file is messy, this header file includes all
// necessary declarations in order to work with a graph landmark object.
...
#include <x_view_core_os/landmarks/graph_landmark/graph_landmark_types.h>

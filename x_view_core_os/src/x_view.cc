...
void XView::processFrameData_2(const FrameData& frame_data) {
...
void XView::writeGraphToFile(const std::string& prefix) const {
  const std::string filename = getOutputDirectory() + prefix +

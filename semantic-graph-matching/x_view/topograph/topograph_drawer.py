...
class TopoGraphDrawer(object):
    ...
    def draw(self):
        ...
        for topograph in self.topograph_list:
            ...
            pos = nx.get_node_attributes(topograph, 'pos')
            ...
            if self.node_visible:
                ...
                if len(positions[0]) == 3:
                    ...
                    node_sizes = [self.node_base_size * 3 / (0.9 + 3 * (pos[2] - min_depth) / depth_range) for pos in positions]
                else:
                    node_sizes = [self.node_base_size for _ in positions]

                color = [d['node_color'] for d in node_dicts]
                nx.draw_networkx_nodes(topograph, pos=pos, node_color=color, node_size=node_sizes)
            ...
            if self.edges_visible:
                ...
                if self.edge_color_type is EdgeColor.EDGE_COLOR:
                    ...
                    nx.draw_networkx_edges(topograph, pos=pos, edgelist=topograph.edges(), width=stiffness,
                                           edge_color=color)
            ...
            if self.labels_visible:
                ...
                nx.draw_networkx_labels(topograph, pos=pos, labels=labels, font_color=label_color,

...
def get_topograph1(dim=3):
    ...
    return generate_topograph(graph_node_list=graph_nodes, graph_edge_list=edges, name="Example Graph 1")


def get_topograph2(dim=3):
    ...
    return generate_topograph(graph_node_list=graph_nodes, graph_edge_list=edges, name="Example Graph 2")

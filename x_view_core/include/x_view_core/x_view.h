...
struct XViewParams {
  /// \brief String referring to a semantic dataset type which must be fully
  ...
  /// \brieff Semantic landmark type to be used as landmark representation,
  ...
  /// \brief Depending on the semantic landmark type, the extracted features are
